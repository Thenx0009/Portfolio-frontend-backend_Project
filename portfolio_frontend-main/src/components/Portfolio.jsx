              ...
              {portfolio.map((stock, index) => {
                ...
                return (
                  <tr key={index} className="text-center">
                    <td className="border border-gray-300 px-1 py-1 text-[12px] sm:text-[17px] sm:px-4 sm:py-2">{stock.name}</td>
                    <td className="border border-gray-300 px-1 py-1 text-[12px] sm:text-[17px] sm:px-4 sm:py-2">{stock.ticker}</td>
                    <td className="border border-gray-300 px-1 py-1 text-[12px] sm:text-[17px] sm:px-4 sm:py-2">{stock.quantity}</td>
                    <td className="border border-gray-300 px-1 py-1 text-[12px] sm:text-[17px] sm:px-4 sm:py-2">
                      ${stock.buyPrice?.toFixed(2) || 'N/A'}
                    </td>
                    <td className="border border-gray-300 px-1 py-1 text-[12px] sm:text-[17px] sm:px-4 sm:py-2">
                      ${stock.currentPrice?.toFixed(2) || 'N/A'}
                    </td>
                    <td className={`border border-gray-300 px-1 py-1 text-[12px] sm:text-[17px] sm:px-4 sm:py-2 ${isProfit ? 'text-green-600' : 'text-red-600'}`}>
